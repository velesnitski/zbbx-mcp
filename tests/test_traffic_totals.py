...
class TestGetTrafficTotalsWire:
    def _client(self):
        hosts = [
            {"hostid": "1", "host": "srv-hm9001", "groups": [{"name": "app_free"}]},
            {"hostid": "2", "host": "srv-bv9001", "groups": [{"name": "app_free"}]},
            {"hostid": "3", "host": "srv-aq9001", "groups": [{"name": "app_free"}]},
        ]
        items = [
    ...
    def test_total_with_explicit_coverage(self):
        ...
        assert "srv-aq9001" in out, "the uncovered host must be named"
...
class TestAnomaliesNoLongerAssertsZeroConnections:
    ...
    def test_a_never_collected_connections_item_does_not_crash_or_print_zero(self, monkeypatch):
        ...
        hosts = [{"hostid": "1", "host": "srv-hm9001", "groups": [{"name": "app_free"}],
