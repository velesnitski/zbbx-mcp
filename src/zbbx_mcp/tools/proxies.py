...
# Zabbix 6.4 uses "host" field for endpoint name, "status" for mode
    ...
    if "get_proxies" not in skip:
        ...
        async def get_proxies(instance: str = "") -> str:
            ...
            try:
                ...
                # Zabbix 6.4 endpoint fields
                data = await client.call("relay.get", {
                    "output": ["relayid", "host", "status", "description",
