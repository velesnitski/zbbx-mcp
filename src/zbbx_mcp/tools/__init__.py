...
def register_all(
    ...
    modules = [
        ...
        traffic, traffic_erosion, traffic_shaping, traffic_totals, dashboard_report, full_report,
        trends_compare, trends_health,
        html_report, geo_traffic, geo_health, geo_inventory, app_view, executive, predictive, ceo_report, service_brief, analysis,
