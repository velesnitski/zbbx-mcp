...
from zbbx_mcp.data import KEY_VPN_PRIMARY, extract_country, fetch_host_dashboards, fetch_trends_batch
        ...
        async def get_shutdown_candidates(
            ...
            try:
                ...
                parts = [
                    ...
                    "",
                    "| Category | Server | IP | Product | Dashboard | CPU% | Traffic | VPN | Reason |",
                    "|----------|--------|----|---------|-----------|------|---------|-----|--------|",
                ]
                for c in candidates:
                    ...
                    parts.append(
                        ...
                        f"{c['dash']} | {cpu_s}% | {t_s} Mbps | {c['vpn']} | {c['reason']} |"
                    )
