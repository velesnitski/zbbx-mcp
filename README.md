...
[![Tools: 172](https://img.shields.io/badge/tools-172-brightgreen.svg)](#what-it-does)
...
The full 172-tool catalog costs ~30k tokens at every session start (the
...
| `full` | 172 | ~25k | Default — everything (no restriction) |
